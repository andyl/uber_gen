defmodule Atree.Executor.RunTest do
  ...
  test "CtxAssign" do
    plan = %PlanAction{action: Atree.Actions.Ctx.Assign, props: %{a: 1, b: 2}}
    ctx = Atree.Executor.Run.with_input(plan)
  ...
  describe "Pipelining" do
    test "Context log is a list" do
      ctx1 = Atree.Executor.Run.with_input(Atree.Actions.Util.Null)
    ...
    test "Appends log list" do
      ctx1 = Atree.Executor.Run.with_input(Atree.Actions.Util.Null)
      ctx2 = Atree.Executor.Run.with_input(ctx1, Atree.Actions.Util.Null)
