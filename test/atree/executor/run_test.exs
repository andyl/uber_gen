defmodule Atree.Executor.RunTest do
  ...
  test "CtxAssign" do
    ...
    ctx = Atree.Executor.Run.auth_action(plan)
  ...
  describe "Pipelining" do
    test "Context log is a list" do
      ctx1 = Atree.Executor.Run.auth_action(Atree.Actions.Util.Null)
    ...
    test "Appends log list" do
      ctx1 = Atree.Executor.Run.auth_action(Atree.Actions.Util.Null)
      ctx2 = Atree.Executor.Run.auth_action(ctx1, Atree.Actions.Util.Null)
