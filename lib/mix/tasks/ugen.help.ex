defmodule Mix.Tasks.Ugen.Help do
  ...
  ## Arguments
      ...
      mix ugen.help                  - prints all aliases, tasks and their short descriptions
      mix ugen.help ALIAS            - prints the definition for the given alias
      mix ugen.help TASK             - prints full docs for the given task
      mix ugen.help --search PATTERN - prints all tasks and aliases that contain PATTERN in the name
      mix ugen.help --names          - prints all task names and aliases
